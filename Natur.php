      ...
      <div id="carouselExampleControls" class="carousel slide" style="height:500px" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="natur1.jpg" class="d-block w-100" alt="infinity-pool">
          ...
          <div class="carousel-item">
            <img src="Natur2.jpg" class="d-block w-100" alt="hotel" >
            <div class="carousel-caption d-none d-md-block">
          ...
          <div class="carousel-item">
            <img src="natur3.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block">
